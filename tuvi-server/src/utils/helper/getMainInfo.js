import { viToEnData } from "./constants";
import { getSao } from "./saoInfo";
import {
  getNumberIndex,
  getMonthName,
  getNumberCanChi,
} from "./numberMonthInfo";
import {
  getDayYangYinInfo,
  getDayYangYinInfoBasic,
} from "./dayYangYinInfo";
import { getBasicInfo } from "./basicInfo";
import { getCungChuInfo } from "./cungChuInfo";
import { lapDiaBan } from "./lapDiaBan";
import diaBan from "./diaBan";
import LapThienBan from "./thienban";
import { getNextDay, getGioSinhIndex } from "./amDuong";
import { getBaziData } from "./batTu";
import { getBatTuTemplate } from "./batTuTemplate";
  ...
  const tamHopCungSaoText = tamHopList
    .map((tamHop, index) => {
      ...
      The Point in external opposition to the ${cung} is the ${
        ...
        cungDaiVan && cungDaiVan.cungChu.toLowerCase() === cung.toLowerCase()
        ...
        thangLuuNguyet
          ? `\n        Flowing with the ${
            ...
            } Monthly timeline : ${getSao(cung, sapXepCungTheoTuoi).luuNguyet}`
          : ""
      }${
